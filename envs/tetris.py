...
class TetrisEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if height + self.piece_height[self.state.next_piece][orient] >= self.n_rows:
            ...
            return self.state, self._get_reward() - 2, True, {}
    ...
    def _get_reward(self):
        ...
        reward function
        """
        reward = 1 + 20*self.cleared_current_turn**2
        return reward
...
if __name__ == "__main__":
    ...
    for _ in range(50):
        ...
        states_and_actions = env.get_next_states_actions()
        state = env.step_predict(action)
